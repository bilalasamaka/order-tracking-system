...
class Customers extends CI_Controller{
    ...
    */
    ...
    public function index(){
        $data['pageContent'] = $this->load->view('customer/customer', '', TRUE);
    ...
    */
    ...
    public function laad_(){
        ...
        $json['adminTable'] = $this->load->view('customer/customerlist', $data, TRUE);//get view with populated customers table
