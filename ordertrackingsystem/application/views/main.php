            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a>
                                Bugün Kazanılan: <b><span id="totalEarnedToday"></span></b>
                            </a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?= site_url('logout') ?>"><i class="fa fa-sign-out"></i> Çıkış</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h4 class="text-center">Sipariş Özeti</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <form name="logInModalForm">
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    <label for='logInPassword' class="control-label">Şifre</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 pull-right">
                                    <button id='loginModalSubmit' class="btn btn-primary">Giriş</button>
                                </div>
                            </div>
                        </form>
                    </div>
