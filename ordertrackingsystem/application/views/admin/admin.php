    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class='modal-header'>
                ...
                <h4 class="text-center">Yeni Admin Ekle</h4>
            ...
            <div class="modal-body">
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='role' class="control-label">Hesap Türü</label>
                            <select class="form-control checkField" id='role'>
                                <option value=''>Tür</option>
                                <option value='Super'>Yönetici</option>
                                <option value='Basic'>Çalışan</option>
                            </select>
            ...
            <div class="modal-body">
                <form id='editAdminForm' name='editAdminForm' role='form'>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='roleEdit' class="control-label">Hesap Türü</label>
