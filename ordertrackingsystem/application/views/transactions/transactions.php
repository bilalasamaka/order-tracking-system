            ...
            <div class="row">
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' id='showTransForm'><i class="fa fa-plus"></i> Yeni Sipariş </button>
                    </span>
                </div>
            </div>
            <br>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2 text-primary pointer">
                                            <button class="btn btn-primary btn-sm" id="clickToClone"><i class="fa fa-plus"></i> Ürün Seç</button>
                                        </div>
                                        
                                        <br class="visible-xs">
                                        
                                        <div class="col-sm-2 form-group-sm">
                                            <input type="text" id="barcodeText" class="form-control" placeholder="Ürün Kodu Giriniz" autofocus>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="modeOfPayment">Ödeme Türü</label>
                                            <select class="form-control checkField" id="modeOfPayment">
                                                <option value="">---</option>
                                                <option value="Cash">Nakit</option>
                                                <option value="POS">POS</option>
                                                <option value="Cash and POS">Nakit ve POS</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="cumAmount">Kümülatif Tutar</label>
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <div id="amountTenderedDiv">
                                                <label for="amountTendered" id="amountTenderedLabel">Ödenecek Tutar</label>
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="changeDue">Para Üstü</label>
