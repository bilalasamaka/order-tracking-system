...
$(document).ready(function(){
    ...
    $("#transListPerPage, #transListSortBy").change(function(){
        displayFlashMsg("Lütfen bekleyiniz...", spinnerClass, "", "");
        latr_();
    });
            ...
            if(bText){
                for(let i in currentItems){
                    ...
                    //if the value doesn't match the code of any item
                        ...
                        $("#itemCodeNotFoundMsg").css('color', 'red').html("Öğe bulunamadı. Öğe kaydedilmemiş olabilir.");
                    }
                }
            }
        }, 1500);
    ...
    $("#showTransForm").click(function(){
        ...
        if($("#newTransDiv").hasClass('collapse')){
            $(this).html("<i class='fa fa-plus'></i> Yeni İşlem");
        }
        
        else{
            $(this).html("<i class='fa fa-minus'></i> Yeni İşlem");
    ...
    $("#hideTransForm").click(function(){
        ...
        $("#showTransForm").html("<i class='fa fa-plus'></i> Yeni İşlem");
    });
...
function gti_(transId){
    if(transId){
        $("#transReceipt").html("<i class='fa fa-spinner faa-spin animated'></i> Yükleniyor...");
...
function calchadue(){
    ...
    if(amountTendered && (amountTendered < cumAmount)){
        $("#amountTenderedErr").html("Tutar "+ cumAmount+ " TL'den daha az olamaz!");
