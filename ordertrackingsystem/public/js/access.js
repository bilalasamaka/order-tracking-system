...
loginForm.onsubmit = function(e){
    ...
    if(!email || !password){
        var errMsg = !email ? "Mail adresinizi giriniz!" : "Şifrenizi giriniz!";
        
        document.getElementById('errMsg').innerHTML = errMsg;
    }
    
    else{
        document.getElementById('errMsg').innerHTML = "Oturum açılıyor......";
	...
	handleLogin(email, password, function(returnedData){
	   if(returnedData.status === 1){
                document.getElementById('errMsg').innerHTML = "Oturum açıldı. Yönlendiriliyor....";
