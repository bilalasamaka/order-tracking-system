...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        if(!itemName || !itemQuantity || !itemPrice || !itemCode){
            ...
            $("#addCustErrMsg").text("Bir veya daha fazla zorunlu alan boş!");
            
            return;
        }
        
        displayFlashMsg("Ürün ekle '"+itemName+"'", "fa fa-spinner faa-spin animated", '', '');
        ...
        $.ajax({
            ...
            error: function(){
                if(!navigator.onLine){
                    changeFlashMsgContent("Çevrimdışı görünüyorsunuz. Lütfen internete tekrar bağlanın ve tekrar deneyin.", "", "red", "");
                }

                else{
                    changeFlashMsgContent("İsteğiniz şu anda işlenemiyor. Lütfen daha sonra tekrar deneyiniz!", "", "red", "");
                }
            }
        });
    });
    ...
    $("#editItemSubmit").click(function(){
        ...
        $("#editItemFMsg").css('color', 'black').html("<i class='"+spinnerClass+"'></i> İşleminiz gerçekleştiriliyor...");
        ...
        $.ajax({
            ...
            if(returnedData.status === 1){
                $("#editItemFMsg").css('color', 'green').html("Ürün başarıyla güncellendi!");
                ...
                $("#editItemFMsg").css('color', 'red').html("Bir veya daha fazla zorunlu alan boş veya düzgün doldurulmamış.");
            ...
            $("#editItemFMsg").css('color', 'red').html("İşleminiz şu anda gerçekleştirilemiyor! Lütfen internet bağlantınızı kontrol edip ve tekrar deneyiniz.");
        });
    });
    ...
    $("#stockUpdateType").on('change', function(){
        ...
        if(updateType && (updateType === 'newStock')){
            $("#stockUpdateDescription").val("Yeni ürünler satın alındı.");
        }
